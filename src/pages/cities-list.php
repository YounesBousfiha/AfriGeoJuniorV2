...
<body class="font-[Oswald]">
    <div class="min-h-[100vh] flex flex-col">
        ...
        <div class="flex flex-grow w-full max-md:flex-col">
            ...
            <section id="cities" class="w-4/5 max-md:w-full">
                ...
                <div class="p-4 flex justify-between items-center">
                    ...
                    <a href="../../src/pages/cruds/city/create.php" class="flex items-center gap-1 cursor-pointer hover:bg-gray-100 p-2 px-4 rounded-md">
                        <span>Add New City</span>
                        <img src="../assets/images/icons/add-icons.svg" class="size-4" alt="">
                    </a>
                    <!-- </div> -->
                </div>
                <div class="relative overflow-auto h-[75vh]">
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 bg-red-200">
                        ...
                        <tbody>
                            ...
                            for ($i = 0; $i < 22; $i++) {
                                ...
                                echo "<th class='px-6 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white'>1</th>";
                                echo "<td class='px-6 py-2'>Rabat</td>";
                                echo "<td class='px-6 py-2'>Capital</td>";
